...
public class HangTrongKhoModel {
	...
	public HangTrongKhoModel() {
	}


	public HangTrongKhoModel(String maHang, String tenHang, int soLuong, double giaMotDonHang, double giaNhap,
			String ngayNhap) {
		this.maHang = maHang;
	...
	public String toString() {
		return "HangTrongKhoModel [maHang=" + maHang + ", tenHang=" + tenHang + ", soLuong=" + soLuong
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HangTrongKhoModel other = (HangTrongKhoModel) obj;
